...
import {
  CHILD_CREATE_SNIPPET_ROUTE,
  CHILD_SNIPPET_ROUTE,
  CHILD_UPDATE_SNIPPET_ROUTE,
  MAINSNIPPET_ROUTE
} from './mainsnippet.route';
...
@NgModule({
  imports: [JhipsterLSharedModule, RouterModule.forChild([MAINSNIPPET_ROUTE, CHILD_SNIPPET_ROUTE, CHILD_UPDATE_SNIPPET_ROUTE, CHILD_CREATE_SNIPPET_ROUTE])],
